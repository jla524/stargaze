...
<div class="homepage-section" data-aos="fade-up" style="margin-top: 4rem;">
  ...
  <div class="resource-grid">
    ...
    {{< resource-card title="SpaceX-xAI Mega Merger" summary="SpaceX and xAI merged at a combined $1.25T valuation to accelerate orbital data centers — SpaceX provides the launch vehicles, xAI provides the AI workloads. The FCC filing covers up to 1 million satellites with 100 GW compute capacity." bullets="Combined $1.25T valuation | FCC filing for 1M data center satellites | Starship targets <$100/kg launch cost | 100 GW — more than all existing cloud data centers combined" link="https://www.reuters.com/business/aerospace-defense/musks-mega-merger-spacex-xai-bets-sci-fi-future-data-centers-space-2026-02-04/" icon="🤝" >}}
